...
{
    public static class HeadOfCharges
    {
        // Property Charges
        public const string ManagementFee = "Management Fee";
        public const string ReserveFund = "Reserve Fund";
        public const string GroundRent = "Ground Rent";
        // Tenants
        public const string BuildingInsurance = "Building Insurance";
        ...
        public const string EstateRoadsDrainageFootpath = "Estate Roads, Drainage and Footpath";
        // Tenants
        ...
        public const string DoorEntrySystem = "Door Entry System";
        // Tenants
        public const string CommunalTVAerial = "Communal TV Aerial";
        public const string LiftMaintenance = "Lift Maintenance";
        public const string HeatingMaintenance = "Heating Maintenance";
        public const string HeatingStandingCharge = "Heating Standing Charge";
        // Tenants
