...
The FinanceChargesListener application provides a template for creating for new Listener applications that is triggered by an AWS SQS message.
...
See the [test project readme](../FinanceChargesListener.Tests/ReadMe.md) for more details.
