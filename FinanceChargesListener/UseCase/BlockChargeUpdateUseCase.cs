...
{
    public class BlockChargeUpdateUseCase : IBlockChargeUpdateUseCase
    {
        ...
        public BlockChargeUpdateUseCase(
        ...
        public async Task ProcessMessageAsync(EntityEventSns message)
        {
            ...
            var assetDetailList = await _assetInformationApiGateway.GetBlockDetails(message.EntityId).ConfigureAwait(false);
