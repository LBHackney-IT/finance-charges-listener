# FinanceChargesListener.Tests

This is the test project for the FinanceChargesListener application.
...
See the [BaseSteps class](/FinanceChargesListener.Tests/E2ETests/Steps/BaseSteps.cs) for more details.
